...
<html lang="en">
    <head>
        ...
        <meta name="author" content="Tanjina Akter"> <!-- Page এর Creator এর পরিচয় নির্দেশ করতে ব্যবহার করা হয়। -->
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="co-md-8 offset-2 p-4 shadow-sm bg-white">
                <?php
               echo  "Hello world!";
               echo  "<br>";
               echo "<h1>What is PHP?</h1>";       
               echo "<ul>What is PHP?</ul>";      
               echo "<li>PHP is an acronym for PHP: Hypertext Preprocessor'</li>";     
               echo "<li>PHP is a widely-used, open source scripting language</li>";     
               echo "<li>PHP scripts are executed on the server</li>";     
               echo "<li>PHP is free to download and use</li>";  
               $txt = "Hello world!";
                $x = 5;
                $y = 10.5;
                $txt = "Bangladesh";
